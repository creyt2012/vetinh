...
const initLeaflet = () => {
    ...
    // Temperature Overlay (OpenWeatherMap Heatmap)
    const tempLayer = L.tileLayer('https://tile.openweathermap.org/map/temp_new/{z}/{x}/{y}.png?appid=b1b15e88fa797225412429c1c50c122a1', {
        maxZoom: 18,
        opacity: 0.65
    });
